...
public class AppiumConfig{
    ...
    protected void setCURRENT_BANK(String CURRENT_BANK ){
    ...
    protected void setDEVICE_NAME(String DEVICE_NAME ){
    ...
    protected void setAPPIUM_PORT(String APPIUM_PORT ){
    ...
    protected void setPLANTFORM_VERSION(String PLANTFORM_VERSION ){
